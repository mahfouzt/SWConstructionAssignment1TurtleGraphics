...
public class RulesOf6005 {
    ...
    public static boolean mayUseCodeInAssignment(boolean writtenByYourself,
       ...
       if(writtenByYourself== true && availableToOthers == true && writtenAsCourseWork == true && citingYourSource == true && implementationRequired==true )
        return true;
       else
        return false;
    ...
    public static void main(String[] args) {
        System.out.println("First code in SW Construction Course (It's great wonderful course): " +
